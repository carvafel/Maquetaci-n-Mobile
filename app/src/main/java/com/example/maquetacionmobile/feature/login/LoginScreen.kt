        ...
        Column(
            ...
            Box(
                ...
                Column(modifier = Modifier.fillMaxWidth()) {
                    ...
                    Spacer(modifier = Modifier.height(responsivePadding(spacing.sm)))
                    ...
                    Button(
                        ...
                        Text(text = "Log In", color = MaterialTheme.colorScheme.onPrimary, fontWeight = FontWeight.SemiBold)
                    }
